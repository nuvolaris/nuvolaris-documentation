...
If you are in a hurry and you don't want to read everything, read our xref:quickstart.md[quick start] installation guide. Otherwise read on, or come back if something does not work.
