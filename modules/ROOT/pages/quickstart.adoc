...
If you have access to kubernetes cluster, you can install Nuvolaris with:
----
nuv setup cluster
----
...
As mentioned before, if you have access to kubernetes cluster, you can install Nuvolaris with:
