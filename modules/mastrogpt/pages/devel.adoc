...
Some parameters are available by default inside nuv .env file. To use these parameters, remember to specify them inside every single action, like here:
...
MastroGPT, to improve user development, offers some util features. For example, every time your source code will changed, it will be immediately available thanks to a scanner that observe your code and notify changes on your development environment.
