...
You may wonder where is the result. Reality is in Nuvolaris all the actions are by default asynchronous, so 
what you get usually the *activation id* to retrieve the result once the action completed.
