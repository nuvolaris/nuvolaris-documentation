...
. you have passwordless access with `ssh` to a Linux user
. the user has passwordless `sudo` rights
. you have the firewall with port 80, 443 and 6443 opened
