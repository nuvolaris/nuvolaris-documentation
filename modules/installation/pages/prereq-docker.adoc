...
You require the 64 bit edition in Intel Architecture of a  recennte version of Windows (at least version 10). The installer `nuv` does not run on 32 bit versions nor in the ARM architecture.
