...
you can install Nuvolaris in it. You can read xref:prereq-cluster.adoc[more details here].
...
. check you have actually access to a Kubernetes cluster, by running this command:
