...
The unique constraint is to place server side code under the `/packages` folder and client side code under the `/web` folder. We'll explain this further in [Environment](./environment.adoc).
...
Every Admin feature is explained in [Environment](./environment.adoc).
