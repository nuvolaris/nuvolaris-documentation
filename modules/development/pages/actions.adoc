== OpenWhisk and Nuvolaris Actions
...
link:development-runtimes[supported languages and runtimes], or from
a binary-compatible executable, or even executables packaged as Docker
containers.

* The Nuvolaris CLI makes it easy to create and invoke actions. Instructions for configuring and using the CLI are available xref:cli.adoc[here].
