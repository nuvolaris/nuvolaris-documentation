...
Nuvolaris can be installed in many environments, using our powerful  command line interface, that can be downladed and installed xref:index-nuv.adoc[from this page].
