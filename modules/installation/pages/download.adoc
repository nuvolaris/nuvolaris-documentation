...
* on various Linux distributions, 64 bit version, for Intel and ARM architectures, in Ubuntu/Debian `deb` and RedHat/SuSE `rpm` format. For Ubuntu you need at lest version 22, for Debian at least version 12.
